...
const NAV_ITEMS: NavItem[] = [
  { label: 'Home', href: '/' },
  {
    ...
    href: '/shows',
    children: [
      { label: 'Trillium-Bronze Hunter Jumper', href: '/shows?series=hunter-jumper' },
      { label: 'Dressage', href: '/shows?series=dressage' },
      { label: 'Development', href: '/shows?series=development' },
      { label: 'Feature Classes', href: '/shows?series=hunter-jumper' },
